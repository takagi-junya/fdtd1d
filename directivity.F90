module directivity 
    ...
    subroutine init_dir()
        ...
        write(30,*)"dt:",dt
        write(30,*)"k0:",ak0
        write(30,*)"itgstr:",itgstr
        write(30,*)"itgend:",itgend
        write(30,*)"omega:",omega
        write(30,*)"k0-omega",ak0*c,omega
    ...
    subroutine out_dir()
        ...
        call hdfopen(filename(15),datasetname(9),file_id(11),group_id(11),0)
        call wrt1d(file_id(11),group_id(11),datasetname(9),dim3,D(:),istat1(11),istat2(11))
